...
/**
 * #### Generated from [ASTViewerModel.kt:8]
 */
class ASTViewerModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        const val serializationHash = -442510422687416653L
        
    }
    override val serializersOwner: ISerializersOwner get() = ASTViewerModel
    override val serializationHash: Long get() = ASTViewerModel.serializationHash
    ...
    override fun print(printer: PrettyPrinter)  {
        printer.println("ASTViewerModel (")
        printer.indent {
    ...
    //deepClone
    override fun deepClone(): ASTViewerModel   {
        return ASTViewerModel(
...
val Solution.aSTViewerModel get() = getOrCreateExtension("aSTViewerModel", ::ASTViewerModel)



/**
 * #### Generated from [ASTViewerModel.kt:10]
 */
enum class MyEnum {
    FirstValue, 
    SecondValue;
...
/**
 * #### Generated from [ASTViewerModel.kt:15]
 */
